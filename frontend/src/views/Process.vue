<template>
  <div class="process-page">
    <!-- Top navigation bar -->
    <nav class="navbar">
      <div class="nav-brand" @click="goHome">POLYLOP</div>
...
const renderGraph = () => {
  ...
  // Close detail panel when clicking blank space
  svg.on('click', () => {
    closeDetailPanel()
  })

  simulation.on('tick', () => {
    // Update position of all edges (including visible lines and transparent click areas)
